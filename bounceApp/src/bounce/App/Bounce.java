...
public class Bounce extends JPanel {
	...
	private void populateModel() {
		...
		_model.add(new RectangleShape(440, 0, 10, 10, 10, 40), root);
		_model.add(new RectangleShape(50, 0, 30, 50), root);
		_model.add(new RectangleShape(0, 0, 5, 2, 50, 70), root);
		_model.add(new DynamicRectangleShape(0, 0, 2, 3, 180, 130, "I change color when I bounce", Color.CYAN), root);
		_model.add(new OvalShape(50,110,2,4), root);
		

		NestingShape child = new NestingShape(10, 10, 2, 2, 100, 100);
		_model.add(new RectangleShape(10, 10, 10, 10, 20, 25), child);
