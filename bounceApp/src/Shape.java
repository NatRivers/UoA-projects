...
public abstract class Shape {
	// === Constants for default values. ===
	    ...
	    protected ArrayList<Shape> shapeLst2 = new ArrayList<Shape>();

	    protected List<Shape> parentLst = new ArrayList<Shape>();
		...
		protected void setParent(NestingShape p) {
			this.parent = p;
			//parentLst.add(this.parent);
		}
		public java.util.List <Shape> path(){
		    //System.out.println(parentLst);
		    ArrayList<Shape> lst = new ArrayList<Shape>();
		    lst.add(this);
		    if (parent() == null){
		        return lst;
		    }else{
		        parentLst = parent().path();
		        parentLst.addAll(lst);
		    }
			return parentLst;
		}
		public void setLst(ArrayList<Shape> list){
		    shapeLst2 = list;
		}
		public String text() {
			return this._text;
